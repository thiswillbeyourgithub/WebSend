...
const i18n = (function() {
    ...
    const translations = {
        en: {
            ...
            'send.transferIncomplete': 'Some of the file was lost in transit. Please send it again.',
            ...
            'send.invalidQR.foreignOrigin': 'Refusing this QR: it points to a different WebSend server than the one you are on. Only scan QRs from the receiver page running on this same server.',
            'send.flashOff': 'Off',
            'send.flashTorch': 'On',
            'send.flashAuto': 'Auto',
            'send.flashUnsupported': 'N/A',
            'send.flashUnsupportedReason': 'Flash is not supported on this device or browser',
            'send.flashFallbackNoFlash': 'Flash failed — photo taken without flash',
            ...
            'send.fileUnreadable': 'Could not read this file. It may have been moved or deleted, or the app was put in the background while picking it. Re-select the file and try again.',
            'send.fileTooLarge': 'This file exceeds the 4 GiB limit and cannot be sent.',
            'send.unexpectedRekey': 'Security warning: the receiver tried to change keys mid-session. The attempt was blocked. If you keep seeing this, start a new pairing.',
            'send.transformFailedUnknown': 'Image edit could not be applied on the receiver and the original is no longer available.',
            'send.transformRetrying': 'Image edit failed on receiver — re-sending the edited image.',
            ...
            'send.queueSendingFiles': '📤 Sending {n} file(s) in background…',
            ...
            'receive.transferIncomplete': 'A file arrived incomplete and was discarded. Ask the sender to retry.',
            'receive.largeFileBlobOnly': 'Large file received: it is available as a download only (no preview, edits, or OCR).',
            ...
            'receive.exportBtnCount': 'Export ({count} file{plural})',
            'receive.selectAll': 'Select All',
            'receive.deselectAll': 'Deselect All',
            'receive.toggleSelect': 'Select (Shift+Click)',
            ...
            'receive.pdfToImages': 'Export pages as images (ZIP)',
            'receive.pdfToOcr': 'Export as searchable PDF (OCR)',
            'receive.pdfExporting': 'Exporting PDF...',
            'receive.discard': 'Delete',
            'receive.discardConfirm': 'Remove this file?',
            ...
            'send.queuedAwaitingReconnect': 'Connection lost: file kept in the queue, it will be sent automatically after reconnecting.',
        ...
        fr: {
            ...
            'send.transferIncomplete': 'Une partie du fichier a été perdue en transit. Veuillez le renvoyer.',
            ...
            'send.invalidQR.foreignOrigin': 'QR refusé : il pointe vers un autre serveur WebSend que celui sur lequel vous êtes. Ne scannez que les QR de la page de réception sur ce même serveur.',
            'send.flashOff': 'Off',
            'send.flashTorch': 'On',
            'send.flashAuto': 'Auto',
            'send.flashUnsupported': 'N/A',
            'send.flashUnsupportedReason': 'Le flash n\'est pas supporté sur cet appareil ou navigateur',
            'send.flashFallbackNoFlash': 'Flash échoué — photo prise sans flash',
            ...
            'send.fileUnreadable': 'Impossible de lire ce fichier. Il a peut-être été déplacé ou supprimé, ou l\'application est passée en arrière-plan pendant la sélection. Resélectionnez le fichier et réessayez.',
            'send.fileTooLarge': 'Ce fichier dépasse la limite de 4 Gio et ne peut pas être envoyé.',
            'send.unexpectedRekey': 'Avertissement de sécurité : le destinataire a tenté de changer les clés en cours de session. La tentative a été bloquée. Si cela persiste, démarrez un nouvel appairage.',
            'send.transformFailedUnknown': 'L\'édition d\'image n\'a pas pu être appliquée chez le destinataire et l\'original n\'est plus disponible.',
            'send.transformRetrying': 'Échec de l\'édition chez le destinataire — renvoi de l\'image éditée.',
            ...
            'send.queueSendingFiles': '📤 Envoi de {n} fichier(s) en arrière-plan…',
            ...
            'receive.transferIncomplete': 'Un fichier est arrivé incomplet et a été ignoré. Demandez à l\'expéditeur de réessayer.',
            'receive.largeFileBlobOnly': 'Fichier volumineux reçu : disponible uniquement en téléchargement (pas d\'aperçu, de retouches ni d\'OCR).',
            ...
            'receive.exportBtnCount': 'Exporter ({count} fichier{plural})',
            'receive.selectAll': 'Tout sélectionner',
            'receive.deselectAll': 'Tout désélectionner',
            'receive.toggleSelect': 'Sélectionner (Shift+Clic)',
            ...
            'receive.crop': 'Recadrer',
            'receive.download': 'Télécharger',
            'receive.pdfToImages': 'Exporter les pages en images (ZIP)',
            'receive.pdfToOcr': 'Exporter en PDF cherchable (OCR)',
            'receive.pdfExporting': 'Export du PDF en cours...',
            'receive.discard': 'Supprimer',
            'receive.discardConfirm': 'Supprimer ce fichier ?',
            ...
            'send.queuedAwaitingReconnect': "Connexion perdue : fichier gardé en file d'attente, il sera envoyé automatiquement après la reconnexion.",
