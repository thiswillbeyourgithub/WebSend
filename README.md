...
- **Internationalization (i18n)**: full English and French translations (UI text, placeholders, tooltips, and `aria-label` / `alt` accessibility text), auto-detected from browser locale
